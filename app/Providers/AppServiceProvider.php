...
class AppServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        \Validator::extend('bill_belongs_to_current_user', 'App\CustomValidationRules\BillBelongsToCurrentUser@validate');
        \Validator::extend('product_code_belongs_to_current_user', 'App\CustomValidationRules\ProductCodeBelongsToCurrentUser@validate');
